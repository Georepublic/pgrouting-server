...
controlService.prototype.saveParams = function() {
	...
	opts+='{"cid":11,"priority":1,"speed":'+$("#motorway_sp").val()+
		',"enabled":"'+$("#motorway_ck").prop("checked")+'"},';
	opts+='{"cid":12,"priority":1,"speed":'+$("#motorwaylnk_sp").val()+
		',"enabled":"'+$("#motorwaylnk_ck").prop("checked")+'"},';
	opts+='{"cid":13,"priority":1,"speed":'+$("#trunkway_sp").val()+
		',"enabled":"'+$("#trunkway_ck").prop("checked")+'"},';
	opts+='{"cid":14,"priority":1,"speed":'+$("#trunkwaylnk_sp").val()+
		',"enabled":"'+$("#trunkwaylnk_ck").prop("checked")+'"},';
	opts+='{"cid":15,"priority":1,"speed":'+$("#primary_sp").val()+
		',"enabled":"'+$("#primary_ck").prop("checked")+'"},';
	opts+='{"cid":16,"priority":1,"speed":'+$("#primarylnk_sp").val()+
		',"enabled":"'+$("#primarylnk_ck").prop("checked")+'"},';
	opts+='{"cid":21,"priority":1,"speed":'+$("#secondary_sp").val()+
		',"enabled":"'+$("#secondary_ck").prop("checked")+'"},';
	opts+='{"cid":22,"priority":1,"speed":'+$("#secondarylnk_sp").val()+
		',"enabled":"'+$("#secondarylnk_ck").prop("checked")+'"},';
	opts+='{"cid":31,"priority":1,"speed":'+$("#tertiary_sp").val()+
		',"enabled":"'+$("#tertiary_ck").prop("checked")+'"},';
	opts+='{"cid":32,"priority":1,"speed":'+$("#residential_sp").val()+
		',"enabled":"'+$("#residential_ck").prop("checked")+'"},';
	opts+='{"cid":42,"priority":1,"speed":'+$("#unclassified_sp").val()+
		',"enabled":"'+$("#unclassified_ck").prop("checked")+'"},';
	opts+='{"cid":62,"priority":1,"speed":'+$("#pedestrian_sp").val()+
		',"enabled":"'+$("#pedestrian_ck").prop("checked")+'"},';
	opts+='{"cid":81,"priority":1,"speed":'+$("#cycleway_sp").val()+
